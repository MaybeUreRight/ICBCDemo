...
public class EncryptUtils {
     ...
     * DES 轉變
     * <p>法算法名稱/加密模式/填充方式</p>
     * <p>加密模式有：電子密碼本模式 ECB、加密塊鏈模式 CBC、加密反饋模式 CFB、輸出反饋模式 OFB</p>
     ...
     * @return 密文或者明文，適用於 DES，3DES，AES
     */
