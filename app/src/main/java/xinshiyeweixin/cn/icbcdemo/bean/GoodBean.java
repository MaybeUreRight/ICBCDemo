...
public class GoodBean {
    ...
    @Generated(hash = 259124760)
    public GoodBean(Long id, int good_id, String name, Integer cat_id, String cat_name, String unit, int market_price, int our_price, String content, String image_url, String video_url, String video_url_local, String ercode_img_url, String sale_url) {
        this.id = id;
